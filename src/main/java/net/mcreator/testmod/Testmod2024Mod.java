...
@Mod("testmod2024")
public class Testmod2024Mod {
	public static final Logger LOGGER = LogManager.getLogger(Testmod2024Mod.class);
	public static final String MODID = "testmod2024";

	public Testmod2024Mod(IEventBus modEventBus) {
